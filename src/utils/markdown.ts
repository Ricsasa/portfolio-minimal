...
const CLASSES = {
    ...
    paragraph: "text-sm leading-relaxed text-black-secondary",
    list: "space-y-1 list-disc pl-5 text-sm leading-relaxed text-black-secondary",
    listItem: "pl-1",
    orderedList:
        "space-y-1 list-decimal pl-5 text-sm leading-relaxed text-black-secondary",
